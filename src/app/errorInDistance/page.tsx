...
import SecondaryButtonAnchorTag from "@/components/global/buttons/anchortag/SecondaryButtonAnchorTag";
    ...
    return (
        <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-3 items-center p-5 border rounded-md border-(--gray-60)">
                    <PrimaryButtonAnchorTag href="/buyWash">
                        Fortsæt
                    </PrimaryButtonAnchorTag>
                    <p className="max-w-md text-sm text-(--gray-60)">
                        Denne knap er kun beregnet til test og bruges ikke i det normale brugerflow.
                    </p>
                </div>
            </div>
