...
// import { ArrowLeft, Clock, MapPin, Check, Timer } from "lucide-react";
...
//         <p className="font-extrabold text-(--brand-gren)]">155 point</p>
//       </header>
...
//           <article className="flex min-h-36 flex-col items-center justify-center rounded-md bg-(--gray-80) p-4 text-center">
//             <Check size={50} className="mb-4 text-(--brand-gren)]" />
//             <p>Højde: 2,6m</p>
//             <p className="mt-3">Sidespejl til sidespejl: 2,55m</p>
//           </article>

//           <article className="flex min-h-36 flex-col items-center justify-center rounded-md bg-(--gray-80) p-4 text-center">
//             <Clock size={50} className="mb-4 text-(--brand-gren)]" />
//             <p>07.00 - 22.00</p>
//           </article>

//           <article className="flex min-h-36 flex-col items-center justify-center rounded-md bg-(--gray-80) p-4 text-center">
//             <Timer size={50} className="mb-4 text-(--brand-gren)]" />
//             <p>{location.car_wash_self} Vask selv</p>
//           </article>

//           <article className="flex min-h-36 flex-col items-center justify-center rounded-md bg-(--gray-80) p-4 text-center">
//             <Timer size={50} className="mb-4 text-(--brand-gren)]" />
//             <p>{location.car_wash_high_pressure} Højtryksforvask</p>
//           </article>

//           <article className="col-span-2 flex min-h-28 flex-col items-center justify-center rounded-md bg-(--gray-80) p-4 text-center">
//             <Timer size={44} className="mb-4 text-(--brand-gren)]" />
//             <p>{location.car_wash_vacuum} Støvsugere</p>
//           </article>
//         </div>
//       </section>
