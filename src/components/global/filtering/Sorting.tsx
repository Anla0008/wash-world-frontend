        ...
        >
            <div className="flex relative">
                {currentDirection === "asc" ? (
                    <>
                        <HiOutlineArrowLongUp className="absolute -left-5.5 -top-8" color="foreground" size={30} />
                        <HiOutlineArrowNarrowDown className="absolute -left-1.5 -top-8" color="foreground" size={30} />
                    </>
                ) : (
                    <>
                        <HiOutlineArrowNarrowDown className="absolute -left-5.5 -top-8" color="foreground" size={30} />
                        <HiOutlineArrowLongUp className="absolute -left-1.5 -top-8" color="foreground" size={30} />
                    </>
                )}
            </div>
            <span>{label}</span>
