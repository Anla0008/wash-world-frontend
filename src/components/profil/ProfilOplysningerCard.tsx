...
import edit, { SectionType } from "@/mockupData/editmode";

const ProfilOplysningerCard = ({ section }: { section: SectionType }) => {
    ...
    <div className="flex flex-col gap-5">
      ...
      {edit[section].fields.map((field) => {
        ...
        return (
          <div
            key={field.key}
            className={`rounded-md p-3 border transition-colors w-full ${
              isFieldActive
                ? "border-(--brand-green) bg-foreground/8"
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className={`px-3 py-2 rounded-sm border w-full ${
                      isFieldActive
                        ? "border-(--brand-green) bg-(--gray-80)"
                        : "border-foreground/20 bg-(--gray-80)/60"
                    }`}
